    ...
    <View style={{ backgroundColor: "#fff", flex: 1 }}>
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <TouchableOpacity onPress={() => setPercentage(p => (parseFloat(p) - 0.5).toFixed(2))} style={{ padding: 15, alignItems: "center", justifyContent: "center" }}><Feather size={20} color={Colors.gray} name="minus"/></TouchableOpacity>
        </View>
